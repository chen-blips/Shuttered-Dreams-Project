...
<head>
    ...
    <link rel="stylesheet" href="photoGalleryStyle.css">
...
<body>
    ...
    <main>
        ...
        <div class="image-gallery gallery-style-2" id="gallery-2">
            <div class="gallery-content">
                <span class="close-button">&times;</span>
                <div class="gallery-column">
        ...
        <div class="image-gallery" id="gallery-5">
            <div class="gallery-content">
                <span class="close-button">&times;</span>
                <div class="gallery-column">
        ...
        <div class="image-gallery" id="gallery-6">
            <div class="gallery-content">
                <span class="close-button">&times;</span>
                <div class="gallery-column">
        ...
        <div class="image-gallery" id="gallery-7">
            <div class="gallery-content">
                <span class="close-button">&times;</span>
                <div class="gallery-column">
        ...
        <div class="image-gallery" id="gallery-8">
            <div class="gallery-content">
                <span class="close-button">&times;</span>
                <div class="gallery-column">
        ...
        <div class="image-gallery" id="gallery-9">
            <div class="gallery-content">
                <span class="close-button">&times;</span>
                <div class="gallery-column">
        ...
        <div class="image-gallery" id="gallery-10">
            <div class="gallery-content">
                <span class="close-button">&times;</span>
                <div class="gallery-column">
        ...
        <div class="image-gallery" id="gallery-11">
            <div class="gallery-content">
                <span class="close-button">&times;</span>
                <div class="gallery-column">
        ...
        <div class="image-gallery" id="gallery-12">
            <div class="gallery-content">
                <span class="close-button">&times;</span>
                <div class="gallery-column">
  ...
  <div class="carousel-track" id="carouselTrack">
    ...
    <div class="testimonial-wrapper">
      <div class="testimonial-text">
        <h4>Feedbacks:</h4>
       <p>"Sobrang grateful namin sa team ng Shuttered Dreams Project! Since the beginning ang ayos nila kausap at very professional.</p>
        <p>Nung dumating ang wedding day at finally nameet na namin ang team nina Sir Jesson at Ms. Roz, sobrang chill at nakakatuwa kasama!</p>
        <p>As someone na awkward sa harap ng camera, napakalma nila kami at napalabas ang natural smiles at reactions namin. Highly recommended talaga!"</p>
    ...
    <div class="testimonial-wrapper">
      <div class="testimonial-text">
        <h4>Feedbacks:</h4>
        <p>Choosing SDP was one of the best decision we made for our wedding! My husband and I are comfortable with each other but awkward when there are people around us and especially posing for photos.</p>
        <p>But Jesson and the whole SDP team made sure we are comfortable and was able to capture our raw emotions! From our prenup up to our wedding, </p>
        <p>all photos edited or not are 5 star rating! Even our parents love the output and they were picking what to be framed/printed.</p>
         <p>Thank you again to the whole team for capturing our wedding so beautifully. Given the chance, we would like to book them again in our future events.</p>
         <p>And would definitely recommend to our friends!</p>
    ...
    <div class="testimonial-wrapper">
      <div class="testimonial-text">
        <h4>Feedbacks:</h4>
         <p>It may took me a long time to share my experience with this team, I have been always happy to see the captures of our wedding day every time I browse the album.</p>
         <p>I have nothing to say but praises and appreciation to Shuttered Dreams Project, for making our simple intimate wedding extravagant!They are not just professional but so much convenient to work.</p>
         <p>It's astounding to see their bubbly energy all throughout, that can make the guests follow their lead.</p>
         <p>How can someone awkward in the camera able to pose like a natural model? That can only be produced by people who have great passion in their field of work.</p>
         <p>Thank you so much Shuttered Dreams Project, for being part of this event of our life. We wish for a great success in your venture!</p>
    ...
    <div class="testimonial-wrapper">
      <div class="testimonial-text">
        <h4>Feedbacks:</h4>
        <p>"On our most special day, wala po kayong kaarte-arte at chill lang po kayong kakwentuhan.</p>
         <p>Mabait at makukulit(still professional) po kayo kaya hindi po nakaka-ilang na magpose at mag-emote.</p>
         <p>Up to now, kinikilig pa rin po ako kapag nakikita ko yung photos which are just the way I imagined it– light, candid, fun yet full of emotions.</p>
    ...
    <div class="testimonial-wrapper">
      <div class="testimonial-text">
        <h4>Feedbacks:</h4>
        <p>HiIGHLY RECOMMENDED! Jesson and JM are professionals not only on their craft but also on how they treat their clients. Magaan, madali at masayang katrabaho.</p>
        <p>Walang dull moments during our e-session, kahit pagod pagod na nakakaenjoy pa rin since di sila nauubusan ng ideas amd pakulo.</p>
       <p>Me and my fiancee were so happy and satisfied sa results  of our e-session. Indeed a great team!</p>
