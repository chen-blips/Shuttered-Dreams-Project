...
<body>
        ...
        <div class="logo-casing">
            <div class="logo-container">
                <div class="logo-centered">
                    <img src="images/SDP_Logo.png" alt="Logo">
                </div>
    ...
    <main>
        <div class="wwacontainer">
            <img src="images/wwaphoto.jpg" class="wwaphoto" alt="Who We Are Photo">
            <div class="wwapara">
                <h2>WHO WE ARE</h2>
                <p class="description">
                    <span class="highlight">Shuttered Dreams Project</span> is a collective
                    group of wedding photographers who have
                    always been passionate about transporting
                    you back to your wedding day with every
                    photograph that we take. Our aim is to
                    capture the feeling, emotion, and spontaneity
                    of your wedding day. Nothing fake. Nothing
                    posed. Our style? <span class="style-note">light, fun, and candid.</span>
                </p>
            </div>
        </div>
        ...
        <div class="featcontainer">
            <div class="featpara">
                <h2>FEATURES</h2>
                <p class="featdescript">
                    Capturing unique memories for every couple is something that we're passionate about. We are humbled to be
                    recognized in several wedding blogs for our hard work and being tagged as one of the
                    rising and recommended wedding photographers in the Philippines.
                </p>
            </div>
...
<div class="rctmtextcontainer">
    <div class="rctmpara">
        <h2>Real Connection, True Moments</h2>
        <p class="rctmdescript">
            We've always been passionate about creativity and fostering genuine human connections—the
            kind that truly resonate. For us, it's those authentic, fleeting moments that matter most.
            Weddings are brimming with these intimate, heartfelt instances, and being able to freeze them in
            time and share them with you for eternity is incredibly meaningful to us.
            <br><br>
            We put our heart and soul into our work because we love what we do. This means
            we'll show up on your day ready to go, with every ounce of energy going towards
            creating a quality collection of images that you will enjoy for the rest of your lives.
        </p>
    </div>
</div>
...
<div class="rctmcontainer">
    <div class="rctmleft">
        <img src="images/aboutUs2.jpg" class="rctmphoto-vertical">
    </div>
    <div class="rctmright">
        <img src="images/aboutUs1.jpg" class="rctmphoto-horizontal">
    </div>
</div>
...
<div class="rctmtextcontainer">
    <div class="rctmpara">
        <h2>On the lookout for Unscripted Moments</h2>
        <p class="rctmdescript">
            <br><strong>NATURAL CANDIDS</strong><br>
            Unmatched in capturing natural candids, your love story will transform into stunning, timeless memories to treasure forever.
            <br><br><strong>IN-BETWEEN MOMENTS</strong><br>
            Catching the subtle brush of hands, stolen glances, and unfiltered laughter, each in-between moment is preserved as a timeless memory of your day.
            <br><br><strong>CINEMATIC STORYTELLING</strong><br>
            Images and film that feel like you’re the star of a Netflix show of your life. They’re more than just documentation, but rather works of art that capture the unique energy and romance of your celebration.
        </p>
    </div>
</div>
    </main>
