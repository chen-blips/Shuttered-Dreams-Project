...
<body>
        ...
        <div class="logo-casing">
            <div class="logo-container">
                <div class="logo-centered">
                    <img src="images/SDP_Logo0.1_White.png" alt="Logo">
                </div>
    ...
    <main>
        <section class="hero-section">
            <h1>Premiere Wedding Experience</h1>
        </section>
        ...
        <section class="pricing-section">
            ...
            <div class="pricing-option">
                <div class="image-placeholder left">
                    <img src="images/service1.jpg" alt="Package 1 Image">
                </div>
                <div class="text-content right">
                    <h3>WOODSTER</h3>
                    <p class="price">₱39,999</p>
                    <p>A great starting point for your special day. Includes essential coverage.</p>
                    <ul>
                        <li>12 Hours of Coverage</li>
                        <li>3 Photographers</li>
                        <li>High Res & Web Size Edited Images</li>
                        <li>Access to All Unedited Images</li>
                        <li>FREE Engraved Crystal USB that Contains All Edited Photos</li>
                    </ul>
                   
                </div>
            </div>
    
            <div class="pricing-option reversed">
                <div class="image-placeholder right">
                    <img src="images/service2.jpg" alt="Package 2 Image">
                </div>
                <div class="text-content left">
                    ...
                    <ul>
                        <li>12 Hours of Coverage</li>
                        <li>3 Photographers</li>
                        <li>High Res & Web Size Edited Image</li>
                        <li>Access to All Unedited Images</li>
                        <li>FREE Engraved Crystal USB that Contains All Edited Photos</li>
                        <br>
                        <li>++ Prenup Photo Session</li>
                    </ul>
            ...
            <div class="pricing-option">
                <div class="image-placeholder left">
                    <img src="images/service3.jpg" alt="Package 3 Image">
                </div>
                <div class="text-content right">
                    <h3>WAYFARER</h3>
                    <p class="price">₱84,999</p>
                    <ul>
                        <li>12 Hours of Wedding Day Documentation</li>
                        <li>3 Photographers</li>
                        <li>High Res & Web Size Edited Images</li>
                        <li>Access to All Unedited Images</li>
                        <li>FREE Engraved Crystal USB that Contains All Edited Photos</li>
                        <li> Prenup Photo Session</li>
                        <li> On-site wedding photo slideshow</li>
                        <li>40 pages 10"x10" wedding photo album</li>
                        <li>Memory box with 50 pcs prints</li>

                    <p>FREE aerial photos (depending on the location, some are NO FLY ZONE)</p>
                    </ul>
                </div>
            </div>
            ...
            <div class="pricing-option reversed">
                <div class="image-placeholder right">
                    <img src="images/service4.jpg" alt="Package 4 Image">
                </div>
                <div class="text-content left">
                    <h3>WANDERER</h3>
                    ...
                    <ul>
                        ...
                        <li>40 pages 10"x10" wedding photo album</li>
                        <li>Memory box with 50 pcs prints</li>
                        <li>++ Birth-to-Engagement Photo Montage</li>
                        <li>++ 20 pages 8"x8" engagement photo album</li>
                        <li>++ 2 pcs 40 pages 8"x8" parents album</li>
                        <li>++ 16"x20" blow up photo with frame</li>
        ...
        <section class="prenup-section">
            <div class="prenup-content">
                <h3>Prenup Photo Session</h3>
                <p class="intro">How many professionally taken photos do you and your partner have, ones that you really love and can fill your home with?</p>
                <p class="intro">An engagement shoot is a chance for us to capture some really beautiful, candid photos of you and your partner in a relaxed environment, just the two of you, being you.</p>
                <p class="intro">Plus, if you're a little camera-shy, it is the perfect opportunity for you to practice being comfortable in front of the camera, in the lead up to your wedding day.</p>
                <p class="intro">Either way, we promise you that we'll have a lot of fun while we're at it.</p>
        
                <div class="prenup-highlights">
                    <div class="highlight">
                        <i class="fas fa-users"></i>
                        <h3>1-2 photographers</h3>
                        <p>Dedicated photographers to capture every moment.</p>
                    </div>
                    <div class="highlight">
                        <i class="far fa-clock"></i>
                        <h3>4 to 6 hours photo session</h3>
                        <p>Ample time for a relaxed and comprehensive shoot.</p>
                    </div>
                    <div class="highlight">
                        <i class="fas fa-images"></i>
                        <h3>Raw & Enhanced Photos</h3>
                        <p>Receive both original and professionally edited images.</p>
                    </div>
                    <div class="highlight">
                        <i class="fas fa-hdd"></i>
                        <h3>FREE customized wooden flash drive</h3>
                        <p>A special keepsake to store your precious memories.</p>
                    </div>
                </div>
                ...
                <div class="exclusive-offer">
                    ...
                    <p>!!! FREE engagement session for Palawan, Siargao, Batanes, and out-of-country locations.</p>
                    <p>Kindly consult with the team on how to avail of this exclusive offer.</p>
                </div>
        
                <div class="prenup-gallery-preview">
                    <h3>Gallery Preview</h3>
                    <div class="gallery-images">
                        <img src="images/Prenup1.jpg" alt="Prenup Photo 1">
                        <img src="images/prenup2.jpg" alt="Prenup Photo 2">
                        <img src="images/prenup3.jpg" alt="Prenup Photo 3"> 
                    </div>
                    <button onclick="window.location.href='photoGallery.php'" class="view-gallery-button">View Full Gallery</button>
                </div>
            </div>
        </section>
        <section class="extras-section">
            ...
            <div class="extras-grid">
              <div class="extra-item">
                <h3>Additional Photographer</h3>
                <div class="extra-content">
                  <p>Additional photographers can capture the reactions, emotions and action from different perspectives...</p>
                  <p class="extra-price">₱6,000</p>
                </div>
              </div>
              <div class="extra-item">
                <h3>16x20 Blow up Photo with Frame</h3>
                <div class="extra-content">
                  <p>Your wedding is one of the best days of your life, and we'll definitely make it well documented...</p>
                  <p class="extra-price">₱3,500</p>
                </div>
              </div>
              <div class="extra-item">
                <h3>Birth to Engagement Photo Montage</h3>
                <div class="extra-content">
                  <p>A professionally produced video of your favorite childhood photographs, growing up, meeting one another...</p>
                  <p class="extra-price">₱5,000</p>
                </div>
              </div>
              <div class="extra-item">
                <h3>Aerial Photos</h3>
                <div class="extra-content">
                  <p>Drone shots can capture dynamic, illustrative images that display the scope and scenic context...</p>
                  <p class="extra-price">₱5,000</p>
                </div>
              </div>
              <div class="extra-item">
                <h3>On-site Wedding Photo Slideshow</h3>
                <div class="extra-content">
                  <p>Slideshow is a great way to view your wedding photos for the first time with your friends and family...</p>
                  <p class="extra-price">₱10,000</p>
                </div>
              </div>
              <div class="extra-item">
                <h3>Memory Box with 50 pcs prints</h3>
                <div class="extra-content">
                  <p>These wedding photo boxes will have you feeling special! This comes with a set of prints...</p>
                  <p class="extra-price">₱5,000</p>
                </div>
              </div>
            </div>
    ...
    <div class="cta-content">
         <p class="cta-text">Reach out to book your date or ask us anything. We’re excited to hear from you!</p>
        <button onclick="window.location.href='contacts.php'" class="cta-contact-button">Contact Us</button>
    </div>
</section>

        <section class="albums-image-placeholder-section">
            <div class="albums-image-placeholder">
