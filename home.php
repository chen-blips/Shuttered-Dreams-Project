...
<head>
  ...
  <script type="module">
        import { createIcons, X } from 'https://cdn.jsdelivr.net/npm/lucide-esm@latest';
        createIcons({ icons: { X } });
    </script>
</head>
</head>
...
<body>
    ...
    <nav class="nav-bar-casing">
        <ul class="nav-bar">
            <li class="dropdown mega-menu-item" id="aboutDropdown">
                <button class="dropbtn">
                    About <i class="fa fa-caret-down"></i>
                </button>
                
                <div class="dropdown-content mega-menu-content" id="megaMenuContent">
    ...
    <ul class="nav-bar">
            ...
            <li>
                <button class="nav-login-btn" onclick="document.getElementById('loginModal').style.display='block'">
                Login
            </button>
        </li>
            <li class="separator"></li>
        
        <li><a href="contacts.php">Book Now</a></li>
    </ul>
</nav>
  ...
  <main>
    ...
    <div class="cta-text">
      <h1>Candid. Honest. You—just as you are.</h1>
      <hr>
      <p>Our lens chases real emotions, not forced smiles.</p>
      <br>
      <a href="photoGallery.php" class="book-now-btn">Browse Gallery</a>
    </div>
  </main>
